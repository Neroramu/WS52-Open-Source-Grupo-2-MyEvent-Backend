  ...
  slides = [
    {
      ...
      title: 'Homenaje al ',
      redtext: 'Perú',
      subtitle: 'Brisas del Titicaca',
    },
    {
      img: '../../assets/img/h4-slide2.png',
      title: 'Cris MJ',
      redtext: 'en Concierto',
      subtitle: 'Arena 1',
    },
    {
      ...
      title: 'Una Noche ',
      redtext: 'Diferente',
      subtitle: 'Centro de Convenciones Bianca',
    },
    {
      img: '../../assets/img/h4-slide4.png',
      title: 'El teatro de ',
      redtext: 'Mi Vida',
      subtitle: 'Auditorio Pentagonito',
    },
  ];
  slideConfig = {
    accessibility: true,
    ...
    arrows: true,
    nextArrow:
      '<i class="fa fa-chevron-right mainslick-next" style="color: #fffff;"></i>',
    prevArrow:
      '<i class="fa fa-chevron-left mainslick-prev" style="color: #fffff;"></i>',
  };
